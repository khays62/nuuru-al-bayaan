...
export async function createGradeSection(payload) {
  try {
    const res = await fetch(apiUrl('/grades/sections'), {
      method: 'POST',
    ...
    console.error('Failed to create grade section:', err);
...
export async function updateGradeSection(id, payload) {
  try {
    ...
    console.error('Failed update grade section:', err);
...
export async function deleteGradeSection(id) {
  try {
    ...
    console.error('Failed to delete grade section:', err);
    return { ok: false, error: 'Network error' };
  }
}
...
export async function getGradeSectionById(id) {
  try {
    ...
    console.error('Failed get grade section:', err);
    return { ok: false, error: 'Network/Server error' };
  }
}
