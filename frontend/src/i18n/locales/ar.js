export default {
  common: {
    ...
    audit: {
      ...
      system: {
        ...
        emptyDescription: 'لا توجد أحداث مسجلة لهذا النطاق.',
      },

      tracking: {
        title: 'التتبع والتدقيق',
        subtitle: 'نشاط النظام بالكامل (تسجيل الدخول/الخروج، تغيير كلمة المرور، وعرض الصفحات).',
        actionsTitle: 'بطاقات الإجراءات',
        actionsSubtitle: 'كل بطاقة تعرض إجراء واحد فقط. اضغط على أيقونة العين لعرض المستخدم والإجراء والصفحة والوصف والوقت بشكل صفوف واضحة.',
        workloadTitle: 'حجم العمليات المنفذة',
        workloadSubtitle: 'كل ما يتم في النظام الآن: إضافة، تعديل، حذف، تفعيل، تعيينات، درجات امتحانات، حضور، إعلانات، جدول، والمزيد.',
        trackedActions: 'العمليات المتتبعة',
        customRangeHint: 'اختر تاريخ البداية والنهاية لتفعيل النطاق المخصص.',
        workstreamsTitle: 'العمل حسب أقسام النظام',
        workstreamsHint: 'يوضح القسم الأكثر نشاطاً في النظام.',
        viewRows: 'عرض الصفوف',
        modalTitle: 'تفاصيل {{label}}',
        modalFallbackTitle: 'تفاصيل التدقيق',
        modalSubtitle: 'أحدث الصفوف المرتبطة بـ {{label}}.',
        modalEmptyTitle: 'لا توجد نشاطات مطابقة.',
        modalEmptyDescription: 'لم يتم العثور على صفوف حديثة لهذا البطاقة.',
        lastActor: 'المنفذ: {{name}}',
        lastTime: 'الوقت: {{time}}',
        lastAction: 'آخر إجراء: {{action}}',
        noRecentDetail: 'لا توجد تفاصيل حديثة',
        timelineTitle: 'الخط الزمني للنشاط',
        timelineHint: 'استخدم أزرار النطاق للتبديل بين اليوم/الأسبوع/الشهر/كل الوقت.',
        eventsTitle: 'آخر الأحداث',
        ...
        kpis: {
          ...
          passwordChanges: 'تغيير كلمات المرور',
          pageViews: 'مشاهدات الصفحات',
        },
        timelineHintStatic: 'هذا المخطط يعرض الاتجاه العام للنشاط عبر كل الوقت.',
      },
    },
  ...
  auth: {
    login: {
      ...
      errors: {
        ...
        accountLocked24hContactAdmin: 'تم قفل اسم المستخدم. حاول مرة أخرى خلال {{time}}.',
        accountLockedTryAgainIn: 'تم قفل اسم المستخدم. حاول مرة أخرى خلال {{time}}.',
        accountBlockedTryAgainIn: 'اسم مستخدم غير معروف. تم حظر تسجيل الدخول. حاول مرة أخرى خلال {{time}}.',
        unknownUsernameBlocked: 'اسم مستخدم غير معروف. تم حظر تسجيل الدخول.',
        unknownUsernameBlockedTryAgainIn: 'اسم مستخدم غير معروف. تم حظر تسجيل الدخول. حاول مرة أخرى خلال {{time}}.',
        unknownUsername: 'اسم مستخدم غير معروف.',
        unknownUsernameWithAttempts: 'اسم مستخدم غير معروف. المحاولات المتبقية: {{count}}.{{hint}}',
        unknownUsernameOrStudentId: 'اسم مستخدم غير معروف.',
        unknownUsernameOrStudentIdWithAttempts: 'اسم مستخدم غير معروف. المحاولات المتبقية: {{count}}.{{hint}}',
  ...
  nav: {
    ...
    announcements: 'الإعلانات',
    privacyControl: 'التحكم بالخصوصية',
    trackingAudit: 'التتبع والتدقيق',
  },

  privacyControl: {
    title: 'التحكم بالخصوصية',
    subtitle: 'إدارة قواعد كلمات المرور، وحماية تسجيل الدخول، ومدة الجلسة، وظهور لوحة الطالب من مكان واحد.',
    auditNoticeTitle: 'تنبيه التدقيق',
    auditNoticeBody: 'يتم تسجيل تغييرات سياسة الخصوصية وبثها لحظيًا حتى تتمكن جميع اللوحات المفتوحة من التحديث بأمان.',
    save: 'حفظ التغييرات',
    saving: 'جارٍ الحفظ...',
    reset: 'إعادة الضبط',
    saved: 'تم تحديث سياسة الخصوصية.',
    refreshing: 'جارٍ تحديث سياسة الخصوصية...',
    loadFailed: 'فشل تحميل سياسة الخصوصية.',
    updateFailed: 'فشل تحديث سياسة الخصوصية.',
    readOnly: 'يمكنك عرض هذه السياسة، لكن حسابك لا يملك صلاحية تعديلها.',
    validation: {
      fixErrors: 'أصلح أخطاء التحقق قبل الحفظ.',
      passwordMinLengthFloor: 'يجب أن يكون الحد الأدنى لطول كلمة المرور 6 على الأقل.',
      passwordMaxLengthFloor: 'يجب أن يكون الحد الأقصى لطول كلمة المرور أكبر من أو مساويًا للحد الأدنى.',
      sessionMin: 'يجب أن تكون مهلة الخمول 5 دقائق على الأقل.',
      loginAttempts: 'يجب أن تكون حدود المحاولات 1 على الأقل.',
      cooldownSeconds: 'يجب أن تكون قيم التهدئة ثانية واحدة على الأقل.',
      lockoutDurationMin: 'يجب أن تكون مدة المنع دقيقة واحدة على الأقل.',
      aiChat: {
        dailyLimitStudent: 'يجب أن يكون حد الطالب اليومي 0 أو أكثر.',
        dailyLimitTeacher: 'يجب أن يكون حد المعلم اليومي 0 أو أكثر.',
        dailyLimitStaff: 'يجب أن يكون حد الموظف اليومي 0 أو أكثر.',
      },
    },
    loginProtection: {
      title: 'حماية تسجيل الدخول',
      subtitle: 'إعداد فترات تهدئة تدريجية قبل المنع الطويل.',
      enabled: 'تفعيل المنع التدريجي',
      enabledHint: 'كلمات المرور الخاطئة تفعّل تهدئات قصيرة أولًا ثم منعًا كاملًا.',
      stage1Attempts: 'محاولات المرحلة 1',
      stage1Cooldown: 'تهدئة المرحلة 1 (ثانية)',
      stage2Attempts: 'محاولات المرحلة 2',
      stage2Cooldown: 'تهدئة المرحلة 2 (ثانية)',
      stage3Attempts: 'محاولات المرحلة 3',
      stage3Cooldown: 'تهدئة المرحلة 3 (ثانية)',
      lockoutSeconds: 'مدة المنع',
      durationUnitMinutes: 'دقائق',
      durationUnitHours: 'ساعات',
      durationUnitDays: 'أيام',
      durationUnitWeeks: 'أسابيع',
      durationUnitMonths: 'أشهر',
    },
    password: {
      title: 'سياسة كلمة المرور',
      subtitle: 'التحكم في طول كلمة المرور وتعقيدها للموظفين والمعلمين والطلاب.',
      minLength: 'الحد الأدنى للطول',
      maxLength: 'الحد الأقصى للطول',
      requireUppercase: 'يتطلب حرفًا كبيرًا',
      requireLowercase: 'يتطلب حرفًا صغيرًا',
      requireNumber: 'يتطلب رقمًا',
      requireSymbol: 'يتطلب رمزًا',
    },
    session: {
      title: 'انتهاء الجلسة',
      subtitle: 'تسجيل خروج تلقائي بعد عدم النشاط، عبر جميع تبويبات المتصفح.',
      idleTimeoutMinutes: 'مهلة الخمول (دقائق)',
      hint: 'عندما لا يكون أي تبويب نشطًا، تنتهي الجلسة بعد هذا العدد من الدقائق.',
    },
    studentDashboard: {
      title: 'ظهور لوحة الطالب',
      subtitle: 'إيقاف التبويب يخفي أيضًا البطاقة أو الودجت المرتبطة به تلقائيًا.',
      withWidget: 'يتحكم أيضًا في الودجت المرتبط بالصفحة الرئيسية.',
      withShortcut: 'يتحكم أيضًا في بطاقة الاختصار المرتبطة.',
      routeOnly: 'يتحكم في ظهور الشريط الجانبي والمسار.',
    },

    aiChat: {
      title: 'حدود الدردشة بالذكاء الاصطناعي',
      subtitle: 'اضبط حد الرسائل اليومية لكل دور. المدير مستثنى.',
      enabled: 'تفعيل دردشة الذكاء الاصطناعي',
      enabledHint: 'عند الإيقاف، لن يتمكن المستخدمون الآخرون من استخدام الدردشة.',
      dailyLimitStudent: 'الطالب (رسائل يوميًا)',
      dailyLimitTeacher: 'المعلم (رسائل يوميًا)',
      dailyLimitStaff: 'الموظف (رسائل يوميًا)',
      dailyLimitHint: 'أدخل 0 لتعطيل هذا الدور.',
    },
  },
  ...
  cohorts: {
    ...
    form: {
      ...
      hints: {
        nameRules: 'من 4 إلى 10 أحرف فقط.',
      },
      validations: {
        nameRequired: 'اسم الدفعة مطلوب.',
        nameLength: 'يجب أن يكون اسم الدفعة من 4 إلى 10 أحرف.',
  ...
  teachers: {
    ...
    form: {
      ...
      usernameHelp: '4-10 أحرف. يمكن للمعلم تسجيل الدخول باسم المستخدم أو البريد الإلكتروني.',
      email: 'البريد الإلكتروني',
      phone: 'الهاتف',
      primaryPhone: 'الهاتف الأساسي',
      ...
      validations: {
        ...
        usernameLength: 'يجب أن يكون اسم المستخدم من 4 إلى 10 أحرف.',
