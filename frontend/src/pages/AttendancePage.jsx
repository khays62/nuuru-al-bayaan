...
export default function AttendancePage() {
  ...
  const [, setPeriodMetaByCode] = useState({});
  ...
  useEffect(() => {
    ...
    run();
  }, [querySectionId, dayOfWeek, mode, jsDayUTC, preferredLessonPeriodCode, selectedDayLabel, canViewAttendance]);
  ...
  }, [querySectionId, queryDate, queryRosterScope, canViewAttendance]);
  ...
  useEffect(() => {
    ...
    load();
  }, [querySectionId, queryMode, queryPeriodCode, queryDate, queryRosterScope, canViewAttendance]);
  ...
  return (
    <div className="p-4 space-y-4">
      {!canViewAttendance && (
        <div className="text-sm text-gray-600">You don’t have permission to view attendance.</div>
      )}
      ...
      <AttendanceTable
        canAct={canViewAttendance ? canActForUi : false}
