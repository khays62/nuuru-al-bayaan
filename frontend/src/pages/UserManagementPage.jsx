...
const ROLE_DEFAULTS = {
  ...
  staff: {
    ...
    teachers: { view: true, add: true, edit: true },
...
//   const { hasPermission } = useAuth();
  ...
  const handleEditUser = (user) => {
    ...
    MODULES.forEach((module) => {
      ...
      // Backward compatibility: if a user had FULL access stored before we introduced new
      // per-action flags for a module, keep FULL semantics by enabling all actions.
