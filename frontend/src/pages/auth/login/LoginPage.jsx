...
export default function LoginPage() {
  ...
  //     // Send to unified /api/auth/login endpoint
  //     const res = await axios.post(
  //       "/api/auth/login",
  //       {
  //         studentId: isStudent ? form.username : undefined,
  //         username: isStudent ? undefined : form.username,
  ...
  //     if (res.data.success) {
  //       // Refresh current user from context
  //       await login(form.username, form.password); // triggers fetchCurrentUser in AuthContext
  //     } else {
...
//     const isStudent = /^[0-9]+$/.test(form.username) || form.username.startsWith("ST");

//     try {
//       // const result = await login(username, password); // ✅ use context method
  
//       // detect student ID (e.g. numeric or starts with ST)
