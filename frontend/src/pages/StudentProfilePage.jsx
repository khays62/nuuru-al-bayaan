...
export default function StudentProfilePage() {
    ...
    // derive meta for printing
    const meta = [];
    if (profile?.latestEnrollment?.academicYear?.yearName) meta.push(`AY: ${profile.latestEnrollment.academicYear.yearName}`);
    if (profile?.latestEnrollment?.grade?.gradeName || profile?.latestEnrollment?.gradeSection?.grade?.gradeName) meta.push(`Grade: ${profile.latestEnrollment.grade?.gradeName || profile.latestEnrollment.gradeSection?.grade?.gradeName}`);
