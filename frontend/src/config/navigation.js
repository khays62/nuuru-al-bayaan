...
import {
  ...
  export const navItems = [
    ...
    { path: "/student-results", label: "Results", roles: ["student"], icon: BarChart2 },
    // { path: "/student-attendance", label: "Attendance", roles: ["student"], icon: BookOpenCheck },
    // { path: "/timetables", label: "Time Table", roles: ["admin", "staff", "student"], module: "announcements", icon: CalendarDays },
    { path: "/fees", label: "Fees", roles: ["admin", "staff", "student"], module: "announcements", icon: DollarSign },
    { path: "/library", label: "Library", roles: ["admin", "staff", "student"], module: "announcements", icon: BookOpenCheck },
    { path: "/announcements", label: "Announcements", roles: ["admin", "staff", "student"], module: "announcements", icon: Megaphone },
