...
import {
    ...
    getPassCardsByClass
} from '../controllers/financePrintingController.js';
import {
    listReceiptStudents,
    getStudentReceiptLedger,
    getFinanceStudentsSummary,
    getPreviousBalanceSummary
} from '../controllers/studentReceiptController.js';
...
import {
    ...
    editPaymentGroup,
    revertPaymentGroup
} from '../controllers/studentFinanceShowController.js';
import {
    chargeStudentFees,
...
} from '../controllers/studentChargeController.js';
import {
    editPaymentTransaction
} from '../controllers/paymentEditController.js';
import {
    chargePayroll,
    payrollFullPayment,
...
import {
    printPayrollList
} from '../controllers/payrollPrintingController.js';
import {
    getExpenseLedger,
    getExpenseChargesByDate,
    updateExpenseCharge,
    deleteExpenseCharge
} from '../controllers/expenseWorkflowController.js';
import {
...
import {
    ...
    getAppointmentSlip
} from '../controllers/financeAppointmentController.js';
import { protect, authorizeRoles } from '../middleware/authMiddleware.js';
import { getAuditLogs } from '../controllers/auditController.js';
import { backfillInvoiceBillingMonth } from '../controllers/financeMaintenanceController.js';
...
router.post('/accounts', protect, authorizeRoles('admin'), createAccount);
router.get('/accounts', protect, authorizeRoles('admin', 'staff'), getAccounts);
router.put('/accounts/:id', protect, authorizeRoles('admin'), updateAccount);
router.post('/accounts/transfer', protect, authorizeRoles('admin'), transferFunds);
router.post('/accounts/income', protect, authorizeRoles('admin'), recordIncome);
...
// Fee Management
router.get('/invoices', protect, authorizeRoles('admin', 'staff'), getInvoices); // Staff can view too
...
// Student Finance - Show/Pay/History (Show button redesign)
...
// Student Finance - Charge / Update / Delete (modal-driven)
...
// Payroll Workflows (modal-driven)
