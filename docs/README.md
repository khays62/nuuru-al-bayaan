...
Kani waa index-ka documents-ka mashruuca. Dhammaan dukumentiyada hoos ku xiran waxay sharxayaan ujeeddo, qaab-dhismeed, API-yada, xogta, iyo sida loo isticmaalo/loo rakibo nidaamka.
...
- API.md — Tilmaamaha API-yada ugu muhiimsan: endpoints, query/body, iyo jawaab celin.
...
- DIAGRAMS.md — Sawirro/diagrams: DFD, ERD, iyo Sequence (Mermaid) si loo fahmo socodka xogta.
